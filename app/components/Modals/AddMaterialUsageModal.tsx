// components/Modals/usage/AddMaterialUsageModal.tsx
'use client';
...
interface Props {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (item: { materialUsed: string; description: string }) => void;
}

export default function AddMaterialUsageModal({
  isOpen,
  onClose,
  onSubmit,
}: Props) {
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    if (!materialUsed.trim()) return;
    onSubmit({ materialUsed, description });
    onClose();
  };
