            ...
            >
              ...
              <div className="space-y-1">
                ...
                <input
                  type="date"
                  required
                  value={formatDateForInput(taskData.startDate)}
                  onChange={(e) =>
              ...
              <div className="space-y-1">
                ...
                <input
                  type="date"
                  required
                  value={formatDateForInput(taskData.endDate)}
                  onChange={(e) =>
              ...
              {mode !== "edit" && (
                <div className="space-y-1">
                  ...
                  <div className="rounded-lg bg-gray-100 px-3 py-2 text-xs text-gray-600 min-h-[40px]">
              ...
              <div className="pt-4 mt-2 border-t border-gray-200 flex justify-between gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 rounded-lg bg-slate-900 text-sm font-medium text-white"
                >
